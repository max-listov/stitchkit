...
| [0103](0103-entrypoints-declare-their-maturity.md) | Every entrypoint declares how settled it is | Accepted — scopes 0098 and 0102; amended by 0198 and 0204 (qualification and disclosure for stable, no calendar limit) | I14 |
...
| [0198](0198-stable-is-earned-and-kept-on-a-budget.md) | Stable is earned, and kept on a budget | Accepted — amends 0103 ("the level changes no versioning policy"): promotion needs two independent consumers, stable breaks cite an ADR, every breaking entry leads with its entrypoints; calendar restriction replaced by 0204 | I14 |
