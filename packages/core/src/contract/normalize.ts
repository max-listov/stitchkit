...
import { formatZodError, zodIssues } from '../internal/zod-issues';
import { AppError } from './errors';

/**
 * Every failure, as the contract's error: normalization of thrown values into
 * `AppError`, the stable code of a thrown value, and validation of a handler's
 * result against the declared output. Transport-neutral — HTTP, tools and
 * realtime all answer through these. Split from the zod formatting in
 * `internal/zod-issues`, which needs no contract and stays the graph's leaf.
 */
