/**
 * The exact invocation the upgrading guide shows, compiled on the Node
 * consumer as well — the declarations are what a Node project resolves.
 *
...
console.log('agent store conformance (node): ok');
