...
test('the maturity table carries the figure the changelog supports', async () => {
  ...
  expect(sentence).toBe('redefined in 20 of the 34 minors since 0.56.2, most recently 0.89.0');
  ...
  expect(application).toBe(
    'redefined in 7 of the 34 minors since 0.56.2, most recently 0.83.0',
  );
  ...
  expect(observability).toBe(
    'redefined in 1 of the 34 minors since 0.56.2, most recently 0.83.0',
  );
