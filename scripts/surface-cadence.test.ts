...
test('the maturity table carries the figure the changelog supports', async () => {
  ...
  expect(sentence).toBe('redefined in 11 of the 25 minors since 0.56.2, most recently 0.75.0');
  ...
  expect(application).toBe(
    'redefined in 6 of the 25 minors since 0.56.2, most recently 0.79.0',
  );
